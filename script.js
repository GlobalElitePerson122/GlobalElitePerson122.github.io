$("document").ready(function(){
	$(".box6-simple-button").click(function(){
		...
		if (x == "box6-simple-button1") {
			...
			document.getElementById("box6-simple-button2").style.borderBottom ="solid #000 4px"
			document.getElementById("box6-simple-button3").style.borderBottom ="solid #000 4px"
		}
			...
			document.getElementById("box6-simple-button1").style.backgroundColor ="#BBB"
			document.getElementById("box6-simple-button2").style.backgroundColor ="#ddd"
			document.getElementById("box6-simple-button3").style.backgroundColor ="#BBB"

			document.getElementById("box6-simple-button1").style.borderBottom ="solid #000 4px"
